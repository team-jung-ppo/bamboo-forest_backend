...
public enum ExceptionType {
    ...
    MEMBER_NOT_FOUND_EXCEPTION(NOT_FOUND, "E006", "The specified member could not be found."),
    UNSUPPORTED_OAUTH2_EXCEPTION(INTERNAL_SERVER_ERROR, "E007", "Unsupported OAuth2 provider."),
    ;
