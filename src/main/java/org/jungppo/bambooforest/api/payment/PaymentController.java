package org.jungppo.bambooforest.api.payment;
...
public class PaymentController {
	...
	public ResponseEntity<ResponseBody<Void>> confirmPayment(@RequestBody String jsonBody) throws
		...
		if (isSuccess) {
			TossPaymentGatewaySuccessResponse tossPaymentGatewaySuccessResponse = objectMapper.readValue(reader,
				TossPaymentGatewaySuccessResponse.class);
			responseStream.close();
		} else {
			TossPaymentGatewayFailureResponse tossPaymentGatewayFailureResponse = objectMapper.readValue(reader,
				TossPaymentGatewayFailureResponse.class);
			responseStream.close();
		}
